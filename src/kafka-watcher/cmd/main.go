...
import (
	...
	"github.com/DrDroidLab/droid-network-mapper/src/kafka-watcher/pkg/config"
	logwatcher2 "github.com/DrDroidLab/droid-network-mapper/src/kafka-watcher/pkg/logwatcher"
